...
public class SearchForFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listProductSearchForFood = new ArrayList<>();
        getResultForFood(listProductSearchForFood);
            ...
            public void onResponse(Call<List<Product>> call, Response<List<Product>> response) {
                ...
                if (!search.equals(null)) {
                    ...
                    if (listProductSearchForFood.size() == 0) {
                        Toast.makeText(SearchForFoodActivity.this, "Couldn't find the matching result you were searching for!", Toast.LENGTH_SHORT).show();
                    }
                }
