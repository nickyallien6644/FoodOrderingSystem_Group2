            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="index.html"><img src="https://zuramai.github.io/mazer/demo/assets/images/logo/logo.png" alt="Logo" srcset=""></a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="https://zuramai.github.io/mazer/demo/form-layout.html" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  ">
                            <a href="https://zuramai.github.io/mazer/demo/table.html" class='sidebar-link'>
                                <i class="bi bi-grid-1x2-fill"></i>
                                <span>Table</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item  ">
                            <a href="https://zuramai.github.io/mazer/demo/table-datatable.html" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  ">
                            <a href="https://zuramai.github.io/mazer/demo/ui-file-uploader.html" class='sidebar-link'>
